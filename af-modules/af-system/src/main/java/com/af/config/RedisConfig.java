...
//														  .withInitialCacheConfigurations(singletonMap(CacheConstant.TEST_DEMO_CACHE, RedisCacheConfiguration.defaultCacheConfig()
...
//	}
    ...
    public CacheManager cacheManager() {
        ...
        redisCacheConfiguration = redisCacheConfiguration.computePrefixWith(cacheName ->
                cacheProperties.getRedis().getKeyPrefix() + "_" + cacheName + "::");
        ...
        return builder.initialCacheNames(cacheNames).cacheDefaults(redisCacheConfiguration).build();
    }
    
    @Bean
    public HashOperations<String,String,Long> redisHashMap(RedisTemplate<String,String> redisTemplate){
